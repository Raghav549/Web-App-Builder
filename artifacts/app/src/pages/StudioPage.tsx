...
import { Image as ImageIcon, Video, X, ArrowLeft, Wand2 } from "lucide-react";
...
export default function StudioPage() {
  ...
  const handleUpload = () => {
    ...
    setMediaUrl("https://picsum.photos/seed/studio/800/800");
  };
        ...
        {mediaUrl ? (
          <div className="space-y-4">
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-muted border border-border">
              <img 
                ...
                style={{ 
                  filter: filter !== "Normal" ? 'contrast(1.1) saturate(1.2)' : 'none' // mock filter effect
                }}
              />
              <Button 
                variant="secondary" 
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              ...
              className="aspect-square rounded-3xl border-2 border-dashed border-primary/30 flex flex-col items-center justify-center gap-2 text-primary hover:bg-primary/5 transition-colors"
            >
            ...
            <button 
              onClick={handleUpload}
              className="aspect-square rounded-3xl border-2 border-dashed border-accent/30 flex flex-col items-center justify-center gap-2 text-accent hover:bg-accent/5 transition-colors"
            >
        ...
        <div className="space-y-4 bg-card border border-card-border p-4 rounded-2xl">
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="comments" className="flex flex-col">
              ...
              <span className="text-xs text-muted-foreground font-normal">Let fans reply to this post</span>
            </Label>
            <Switch 
              id="comments" 
